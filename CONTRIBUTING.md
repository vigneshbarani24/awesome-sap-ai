...
2. Edit `README.md` to add your resource in the appropriate category
...
- Broken links or defunct projects
...
- GitHub repos should have a README explaining what the project does
- The resource should be **actively maintained** or still relevant
- Links must work at the time of submission
